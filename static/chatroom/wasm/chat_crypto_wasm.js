 ...
 * @returns {string}
 */
export function generate_aes_key() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.generate_aes_key();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
/**
 * @param {string} aes_key_b64
 * @param {string} public_key_pem
 * @returns {string}
 */
export function encrypt_aes_key_with_rsa(aes_key_b64, public_key_pem) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(aes_key_b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(public_key_pem, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.encrypt_aes_key_with_rsa(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function decrypt_aes_key_with_rsa(encrypted_key_b64, private_key_pem) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.decrypt_aes_key_with_rsa(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
 ...
 * @returns {string}
 */
export function encrypt_message(aes_key_b64, plaintext, nonce_b64) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(aes_key_b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
export function decrypt_message(aes_key_b64, ciphertext_b64, nonce_b64) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(aes_key_b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('chat_crypto_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
