...
SECRET_KEY = 'django-insecure-@vdu1d$=dbnrz+)y+8!w3w1679lmu83b$j_t_k_2%0#pm*fv_3'
...
# Channels settings
ASGI_APPLICATION = 'zcore.asgi.application'

# Channel layer config for Redis (production)
CHANNEL_LAYERS = {
    'default': {
